...
namespace ProjetoFinal.Controllers
{
    public class ItemPedidoController : Controller
    {
        ...
        public ItemPedidoController(ProjetoFinalDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.ItemsPedidos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("IdItemPedido,Quantidade,IdProduto,IdPedido")] ItemPedido itemPedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdItemPedido,Quantidade,IdProduto,IdPedido")] ItemPedido itemPedido)
        {
        ...
        {
            return _context.ItemsPedidos.Any(e => e.IdItemPedido == id);
        }
    }
}
